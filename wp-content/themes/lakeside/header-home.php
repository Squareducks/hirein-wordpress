...
<title><?php wp_title ( '|', true,'right' ); ?> <?php echo $town; ?> - Hire In</title>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 right-grid">
						...
						<li class="location-finder"><a class="phone" href="tel:08081151064"><img src="<?php bloginfo('template_url'); ?>/img/phone-icon.png" alt="Call Us" title="Call Us"></a></li>
						<li class="second-col">
		...
		<section class="nav-col">
			...
			<nav>
				<ul class="outer-ul">
					...
					<span class="back-link"><a href="/scaffold-towers/" title="Scaffold">Scaffold</a></span>
