               ...
               <table class="comm-table">
                  ...
                  <!--  <tr>
                   ...
                   <xsl:for-each select="FEEDBACKLIST/FEEDBACK">
                       ...
                       <!-- time tag used here in HTML5 only might cause issues with legacy browsers -->
                           ...
                           Date Added: <time itemprop="datePublished"><xsl:attribute name="datetime"><xsl:value-of select="HREVIEWDATE" disable-output-escaping="yes" /></xsl:attribute><xsl:value-of select="DATE" disable-output-escaping="yes" /></time>
                           </a>
