...
<link rel="icon" href="<?php bloginfo('template_url'); ?>/wp-content/themes/Lakeside/favicon-32x32.png" type="image/png"/>
<link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/wp-content/themes/Lakeside/favicon.ico" />
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 right-grid">
						...
						<li class="mobile-search"><img src="https://www.eurocarparts.com/theme/ecp/assets/images/mobile-search-icon.svg" alt="Search" title="Search"></li>
  ...
  <a href="/basket/" tabindex="0" class="basket-icon" role="button"
	...
	<section class="nav-col">
			...
			<nav>
				<ul class="outer-ul">
					<li class="tier1nav">
					<a class="onlydlink" href="/scaffold-hire-prices/" title="Scaffold">Scaffold</a><div class="sub-nav out-list" style="display: none;">
					...
					<li class="tier1nav ">
						<a class="onlydlink" href="#" title="Other Access">Other Access</a>
						<div class="sub-nav out-list" style="display: none;">
							<span class="back-link"><a href="javascript:void(0);" title="">Other Access</a></span>
							<ul class="left-sub-nav">
							<li class="sub-li">
